package com.irelint.easyandroid.widget;
...
//            setTopDrawables(mLoadingMessageView,mLoadingDrawable);// loading 不能已经有loading image view ，不能直接设置TopDrawable
    ...
    private void setDefaultValues() {
        if (mEmptyView==null) {
            mEmptyView = (ViewGroup) mInflater.inflate(R.layout.layout_empty, null);
        ...
        if (mErrorView==null) {
            mErrorView = (ViewGroup) mInflater.inflate(R.layout.layout_error, null);
